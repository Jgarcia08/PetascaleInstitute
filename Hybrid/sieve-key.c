 ...
 *
 * Hybrid code
 *  -- to run, use aprun -n p ./sieve-hybrid.o -n i, where p is the number of
 *     processors and i is the integer under which to find primes.
 */
#include <math.h>
#include <mpi.h>
#include <stdio.h>
...
int main(int argc, char **argv) {
	...
	int max = 0; /* The max size for list2 */
